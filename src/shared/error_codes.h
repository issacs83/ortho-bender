...
typedef enum {
    ...
    ERR_MOTION_STALL_DETECTED   = 0x0201,
    ERR_MOTION_OVERCURRENT      = 0x0202,
    ERR_MOTION_ESTOP_ACTIVE     = 0x0203,
    ERR_MOTION_INVALID_BCODE    = 0x0204,
    ERR_MOTION_AXIS_DISABLED    = 0x0205,
    ERR_MOTION_WIRE_NOT_DETECTED = 0x0206,

    /* TMC5160 Driver (0x0280 - 0x02FF) */
    ERR_TMC_SPI_FAULT           = 0x0280,
    ERR_TMC_OVERTEMP            = 0x0281,
    ERR_TMC_SHORT_CIRCUIT       = 0x0282,
    ERR_TMC_OPEN_LOAD           = 0x0283,
    ERR_TMC_UNDERVOLTAGE        = 0x0284,
    ERR_TMC_DRIVER_ERROR        = 0x0285,

    /* Sensor / Thermal (0x0300 - 0x03FF) */
    ERR_SENSOR_TEMP_OVERTEMP    = 0x0300,
    ERR_SENSOR_ADC_FAULT        = 0x0301,
    ERR_SENSOR_NOT_CALIBRATED   = 0x0302,
