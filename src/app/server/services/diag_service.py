...
class DiagService:
    ...
    async def probe_drivers(self) -> list[DriverProbeResult]:
        ...
        # Mock SPI returns plausible chip-ID patterns that would fool the
        # probe and falsely light up drivers in the UI — short-circuit to
        # connected=False unless the backend is real hardware.
