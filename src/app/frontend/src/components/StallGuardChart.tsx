...
export function StallGuardChart({ threshold, height = 250 }: StallGuardChartProps) {
    ...
    <div>
      <ResponsiveContainer width="100%" height={height}>
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="tmc260c_0" stroke={COLORS.tmc260c_0} dot={false} strokeWidth={2} name="FEED" />
          <Line type="monotone" dataKey="tmc260c_1" stroke={COLORS.tmc260c_1} dot={false} strokeWidth={2} name="BEND" />
          <Line type="monotone" dataKey="tmc5072_m0" stroke={COLORS.tmc5072_m0} dot={false} strokeWidth={2} name="ROTATE" />
          <Line type="monotone" dataKey="tmc5072_m1" stroke={COLORS.tmc5072_m1} dot={false} strokeWidth={2} name="LIFT" />
        </LineChart>
      </ResponsiveContainer>
      <div style={{ display: 'flex', gap: 12, fontSize: 11, color: '#94a3b8', marginTop: 4, flexWrap: 'wrap' }}>
